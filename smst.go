...
func NewSparseMerkleSumTrie(nodes kvstore.KVStore, hasher hash.Hash, options ...Option) *SMST {
	smt := &SMT{
...
func ImportSparseMerkleSumTrie(nodes kvstore.KVStore, hasher hash.Hash, root []byte, options ...Option) *SMST {
